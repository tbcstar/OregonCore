   ...
   // bool OnGossipSelect(Player* player, Item* item, uint32 sender , uint32 action)
     bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF+999:
            ...
            //delete gobj
        case GOSSIP_ACTION_INFO_DEF +2: getClosestObjectAndDelete(player); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+999); break;
            //delete NPC
        case GOSSIP_ACTION_INFO_DEF +6: deleteNPC(player); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+999); break;
        ...
        case GOSSIP_ACTION_INFO_DEF +5:  
            ...
            //ADD ITEMS
        case GOSSIP_ACTION_INFO_DEF +100: spawnGoObject(player, ITEM_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +110: spawnGoObject(player, ITEM_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +120: spawnGoObject(player, ITEM_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +130: spawnGoObject(player, ITEM_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +140: spawnGoObject(player, ITEM_5) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +150: spawnGoObject(player, ITEM_6) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +160: spawnGoObject(player, ITEM_7) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +170: spawnGoObject(player, ITEM_8) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +180: spawnGoObject(player, ITEM_9) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +190: spawnGoObject(player, ITEM_10); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +255: spawnGoObject(player, ITEM_11); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +256: spawnGoObject(player, ITEM_12); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +257: spawnGoObject(player, ITEM_13); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
        case GOSSIP_ACTION_INFO_DEF +258: spawnGoObject(player, ITEM_14); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+500); break;
            //ADD NPCS
        case GOSSIP_ACTION_INFO_DEF +200: spawnNPC(player, NPC_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +210: spawnNPC(player, NPC_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +220: spawnNPC(player, NPC_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +230: spawnNPC(player, NPC_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +240: spawnNPC(player, NPC_5) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +250: spawnNPC(player, NPC_6) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +260: spawnNPC(player, NPC_7) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +270: spawnNPC(player, NPC_8) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +280: spawnNPC(player, NPC_9) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +290: spawnNPC(player, NPC_10); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +291: spawnNPC(player, NPC_11); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;
        case GOSSIP_ACTION_INFO_DEF +292: spawnNPC(player, NPC_12); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+501); break;

            //package 1
        case GOSSIP_ACTION_INFO_DEF +300: spawnGoObject(player, P1_ITEM_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +310: spawnGoObject(player, P1_ITEM_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +320: spawnGoObject(player, P1_ITEM_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +330: spawnGoObject(player, P1_ITEM_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +340: spawnGoObject(player, P1_ITEM_5) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +350: spawnNPC(player, P1_NPC_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +360: spawnNPC(player, P1_NPC_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +370: spawnNPC(player, P1_NPC_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +380: spawnNPC(player, P1_NPC_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;
        case GOSSIP_ACTION_INFO_DEF +390: spawnNPC(player, P1_NPC_5); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+502); break;

            //package 2
        case GOSSIP_ACTION_INFO_DEF +400: spawnGoObject(player, P2_ITEM_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +410: spawnGoObject(player, P2_ITEM_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +420: spawnGoObject(player, P2_ITEM_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +430: spawnGoObject(player, P2_ITEM_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +440: spawnGoObject(player, P2_ITEM_5) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +450: spawnNPC(player, P2_NPC_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +460: spawnNPC(player, P2_NPC_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +470: spawnNPC(player, P2_NPC_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +480: spawnNPC(player, P2_NPC_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +490: spawnNPC(player, P2_NPC_5); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;
        case GOSSIP_ACTION_INFO_DEF +1500: spawnNPC(player, P2_NPC_6); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+503); break;

            //package 3
        case GOSSIP_ACTION_INFO_DEF +600: spawnGoObject(player, P3_ITEM_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +610: spawnGoObject(player, P3_ITEM_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +620: spawnGoObject(player, P3_ITEM_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +630: spawnGoObject(player, P3_ITEM_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +640: spawnGoObject(player, P3_ITEM_5) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +650: spawnNPC(player, P3_NPC_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +660: spawnNPC(player, P3_NPC_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +670: spawnNPC(player, P3_NPC_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +680: spawnNPC(player, P3_NPC_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +690: spawnNPC(player, P3_NPC_5); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;
        case GOSSIP_ACTION_INFO_DEF +700: spawnNPC(player, P3_NPC_6); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+504); break;

            //package 4
        case GOSSIP_ACTION_INFO_DEF +910: spawnGoObject(player, P4_ITEM_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +920: spawnGoObject(player, P4_ITEM_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +930: spawnGoObject(player, P4_ITEM_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +940: spawnGoObject(player, P4_ITEM_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +950: spawnGoObject(player, P4_ITEM_5) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +960: spawnNPC(player, P4_NPC_1) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +970: spawnNPC(player, P4_NPC_2) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +980: spawnNPC(player, P4_NPC_3) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +990: spawnNPC(player, P4_NPC_4) ; OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +1000: spawnNPC(player, P4_NPC_5); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +1010: spawnNPC(player, P4_NPC_6); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
        case GOSSIP_ACTION_INFO_DEF +1020: spawnNPC(player, P4_NPC_7); OnGossipSelect(player, creature, creature->GetGUID(), GOSSIP_ACTION_INFO_DEF+505); break;
...
bool spawnNPC(Player *pPlayer, uint32 npcID)
{
    if(isCharacterInLand(pPlayer)){
        ...
        if(getNPCCount(pPlayer->GetGUIDLow()) < NPC_SPAWN_LIMIT + bonus)
        {
            ...
            if (!creature->Create(sObjectMgr.GenerateLowGuid(HIGHGUID_UNIT), map, 1, npcID, 0, 1, player_x, player_y, player_z)){
                delete creature;
                return false;
            }
...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "add",         SEC_GAMEMASTER,     false, &HandleAddPlayerHouse,                 "" },
            { "fix",         SEC_ADMINISTRATOR,  false, &HandleFixPlayerHouse,                 "" },
            { NULL,             0,                  false, NULL,                               "" }
        };
    ...
    static bool HandleAddPlayerHouse(ChatHandler* handler, char const* args)
    {
        ...
        Creature* creature = new Creature;
        if (!creature->Create(sObjectMgr.GenerateLowGuid(HIGHGUID_UNIT), map, player->GetPhaseMaskForSpawn(), 594, 0, 1, player_x+1, player_y+1, player->GetPositionZ()))
            delete creature;
